...
printf '%s\n' '{"TailscaleIPs":["100.64.0.7"]}' >"$fixture_directory/status.json"
printf '%s\n' '{"Node":{"StableID":"peer-private"}}' >"$fixture_directory/whois.json"
...
printf '%s\n' '{"Node":{"StableID":"peer-private"},"UserProfile":{"LoginName":"secret"}}' >"$fixture_directory/unknown-identity.json"
