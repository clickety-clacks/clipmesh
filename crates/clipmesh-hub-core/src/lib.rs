...
//! seam: state changes, recipient selection, queue cutoff, and the final
//! eligibility check before a caller hands a frame to a transport all happen
//! while its single lock is held.
...
mod tests {
    ...
    #[test]
    fn administrative_mutations_cut_off_queues_before_transport_handoff() {
        let fixture = fixture(HistoryMode::Sqlite, RetentionLimits::default());
        let source = create_device(&fixture.core, &fixture.administrator, "Source", 1);
